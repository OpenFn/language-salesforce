...
exports.humanProper = exports.alterState = exports.arrayToString = exports.toArray = exports.beta = exports.index = exports.lastReferenceValue = exports.referencePath = exports.dataValue = exports.dataPath = exports.merge = exports.combine = exports.map = exports.sourceValue = exports.source = exports.field = exports.fields = exports.join = exports.each = exports.relationship = exports.lookup = exports.query = exports.upsertIf = exports.upsert = exports.update = exports.steps = exports.reference = exports.execute = exports.createIf = exports.create = exports.bulk = undefined;
...
function bulk(sObject, operation, options, fun) {
  ...
  return function (state) {
    ...
    var result = { sObject: sObject, operation: operation, options: options, records: fun(state) };
