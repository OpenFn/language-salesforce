...
exports.index = exports.lastReferenceValue = exports.referencePath = exports.dataValue = exports.dataPath = exports.merge = exports.combine = exports.map = exports.sourceValue = exports.source = exports.field = exports.fields = exports.join = exports.each = exports.relationship = exports.lookup = exports.upsert = exports.steps = exports.reference = exports.execute = exports.create = undefined;
...
function execute() {
  ...
  return function (state) {
    ...
    return _languageCommon.execute.apply(undefined, _toConsumableArray((0, _lodashFp.flatten)(operations)))(_extends({}, initialState, state)).then(function (state) {
