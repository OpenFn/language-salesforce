...
exports.reference = exports.update = exports.upsertIf = exports.upsert = exports.createIf = exports.create = exports.bulk = exports.query = exports.describeGlobal = exports.describe = void 0;
...
var describeGlobal = (0, _lodashFp.curry)(function (sObject, state) {
  var connection = state.connection;
  return connection.describeGlobal().then(function (res) {
